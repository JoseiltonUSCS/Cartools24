...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cartools.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Cartools.Models.LojaParceira", b =>
                {
                    b.Property<int>("LojaParceiraId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LojaParceiraId"), 1L, 1);
                    ...
                    b.HasKey("LojaParceiraId");

                    b.ToTable("LojaParceira", (string)null);
                });
            ...
            modelBuilder.Entity("Cartools.Models.Servico", b =>
                {
                    ...
                    b.HasOne("Cartools.Models.Cliente", "Cliente")
                        .WithMany("Servicos")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cartools.Models.LojaParceira", "LojaParceira")
                        .WithMany("Servicos")
                        .HasForeignKey("LojaParceiraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
